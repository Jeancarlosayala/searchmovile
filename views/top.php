<div>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark mt-2" id="top">
    ...
    <div class="row mt-4 mx-auto">
        <div class="col col-sm-3">
            <a href="#" data-toggle="modal" data-target="#SamsungA50" class="card-link">
                <div class="card">
            ...
            <div class="modal fade" id="SamsungA50" tabindex="-1" role="dialog" arial-labelldby="Title"
                arial-hidden="true">
        ...
        <div class="col col-sm-3">
            <a href="#" data-toggle="modal" data-target="#HuaweiP30" class="card-link">
                <div class="card">
                    <div class="card-header">
                        <h4>Huawei P30</h4>
                    </div>
            ...
            <div class="modal fade" id="HuaweiP30" tabindex="-1" role="dialog" arial-labelldby="Title"
                arial-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
        ...
        <div class="col col-sm-3">
            ...
            <div class="modal fade" id="XiaomiredminoteS9" tabindex="-1" role="dialog" arial-labelldby="Title"
                arial-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
        ...
        <div class="col col-sm-3">
            <a href="#" class="card-link" data-toggle="modal" data-target="#Iphone11">
                <div class="card">
                    <div class="card-header">
                        <h4>Iphone 11</h4>
                    </div>
            ...
            <div class="modal fade" id="Iphone11" tabindex="-1" role="dialog" arial-labelldby="Title"
                arial-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
