...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="col col-2">
            <div class="card-body">
                <a class="navbar-brand" href="index.php"><img src="img/logo.png" alt="" class="card-img-top" id="logo"></a>
            </div>
        </div>
        <form class="form-inline ml-auto" action="views/buscador.php" method="POST">
